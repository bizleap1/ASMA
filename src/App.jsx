...
const TopNav = () => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 flex flex-col ${isNavSolid ? 'bg-white/95 backdrop-blur-md shadow-md border-b border-gray-100' : 'bg-transparent border-transparent'}`}>
      ...
      <nav className="w-full py-3 md:py-4 px-4 md:px-8 lg:px-12 transition-all duration-500">
        <div className="container mx-auto flex justify-between items-center gap-2 lg:gap-4">
          <div className="flex items-center gap-2 flex-none">
            <img src={isNavSolid ? "/logo-dark.png" : "/logo.png"} alt="Advait Stock Market Academy Logo" className={`flex-none h-16 md:h-20 w-auto object-contain drop-shadow-md transition-all duration-500 ease-in-out origin-left ${isNavSolid ? 'scale-80' : 'scale-100'}`} onError={(e) => {
...
const VideoHero = () => (
  <>
    <section id="home" className="min-h-[100svh] relative overflow-hidden flex flex-col pt-32 md:pt-40 pb-10">
      ...
      <div className="relative z-20 flex-grow flex flex-col justify-start mt-8 items-start text-left px-6 md:px-16 lg:px-24 w-full space-y-6">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-sans font-black leading-tight text-white drop-shadow-[0_5px_15px_rgba(0,0,0,0.6)] animate-fadeInUp">
          Advait Stock <br /> Market Academy
        </h1>
        <div className="pl-6 md:pl-8 border-l-[6px] border-accent-primary ml-1 md:ml-2 animate-fadeInUp delay-200">
